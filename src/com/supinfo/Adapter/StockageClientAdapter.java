...
public class StockageClientAdapter extends BaseAdapter {
	...
	public StockageClientAdapter(Context context, List<Stockageclient> aListSc) {
		  mContext = context;
		  mListSc = aListSc;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		LinearLayout layoutItem;
		  ...
		  if (convertView == null) {
		    ...
		    layoutItem = (LinearLayout) mInflater.inflate(R.layout.stockageclient_layout, parent, false);
		  } else {
	...
	public interface StockageclientAdapterListener {
	    public void onClickNom(Stockageclient item, int position);
	}
	
	private ArrayList<StockageclientAdapterListener> mListListener = new ArrayList<StockageclientAdapterListener>();
	/**
	 * Pour ajouter un listener sur notre adapter
	 */
	public void addListener(StockageclientAdapterListener aListener) {
